...
options:
  ...
  --archive 0         (0/1) Загрузить ли книгу в Онлайн Архив archive.org (для удобной конвертации и оптимизации)
...
`--max_size` - Максимальный размер папки с загрузками в ГБ. во время работы скрипта будет постоянно проверять размер папки. (Нужно, если диск маленький, или особенно если в Virtual Machine раните)
